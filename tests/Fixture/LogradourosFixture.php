...
class LogradourosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cep' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_bairro_idx' => ['type' => 'index', 'columns' => ['bairro_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_bairro' => ['type' => 'foreign', 'columns' => ['bairro_id'], 'references' => ['tb_bairros', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
