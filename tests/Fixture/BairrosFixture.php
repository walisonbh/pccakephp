...
class BairrosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_cidade_bairro_idx' => ['type' => 'index', 'columns' => ['cidade_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_cidade_bairro' => ['type' => 'foreign', 'columns' => ['cidade_id'], 'references' => ['tb_cidades', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'cidade_id' => 1,
            'created' => '2017-07-07 23:57:38',
            'modified' => '2017-07-07 23:57:38'
        ],
    ];
}
